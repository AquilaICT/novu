const tokens = {
  ...
  "sizes.components.input.height": {
    "value": "var(--nv-sizes-components-input-height)",
    "variable": "var(--nv-sizes-components-input-height)"
  },
  "spacing.molecules.form.input.button": {
    "value": "var(--nv-spacing-molecules-form-input-button)",
  ...
  "shadows.dark": {
    "value": "var(--nv-shadows-dark)",
    "variable": "var(--nv-shadows-dark)"
  },
  "shadows.color": {
    "value": "var(--nv-shadows-color)",
    "variable": "var(--nv-shadows-color)"
  },
  "gradients.vertical": {
    "value": "var(--nv-gradients-vertical)",
    "variable": "var(--nv-gradients-vertical)"
  },
  "gradients.horizontal": {
    "value": "var(--nv-gradients-horizontal)",
  ...
  "gradients.darkDisabled": {
    "value": "var(--nv-gradients-dark-disabled)",
